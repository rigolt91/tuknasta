    ...
    <div class="bg-white border-t">
        <footer class="px-4 py-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('abaut-us') }}" class="text-gray-600 hover:underline">
                                    {{__('Abaut Us')}}
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a wire:click="$emit('openModal', 'politics.terms-and-conditions')" class="text-gray-600 hover:underline hover:cursor-pointer">
                    ...
                    <div>
                        <h3 class="mb-6 text-sm font-semibold text-gray-800 uppercase">
                            {{__('Contact Us')}}
                        </h3>
                        <ul>
                            <li class="mb-4">
                                <div class="flex text-gray-800">
                                    <svg width="16" height="16" fill-rule="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                    </svg>
                                    <span class="pl-2">+5331345200</span>
                                </div>
                            </li>
                            <li>
                                <div class="flex text-gray-800">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center">© 2023 <a class="hover:underline">Agroint</a>. All rights reserved. v1.0</span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" class="text-gray-500 hover:text-gray-900">
                        <svg class="w-5 h-5" fill-rule="currentColor" viewBox="0 0 24 24" aria-hidden="true">
