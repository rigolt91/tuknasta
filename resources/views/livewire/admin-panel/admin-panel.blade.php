<div class="py-12">
    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-6">
        <div class="grid grid-cols-3">
            <div class="mx-2 mb-4">
                <a href="{{ route('admin-panel.categories') }}">
                    <x-card class="bg-emerald-700 mb-2 hover:shadow-md">
                        <x-card-header class="border-none text-white text-lg font-bold -m-2">
                ...
                <a href="{{ route('admin-panel.subcategories') }}">
                    <x-card class="bg-emerald-600 mb-2 hover:shadow-md">
                        <x-card-header class="border-none text-white text-lg font-bold -m-2">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2">{{__('Subcategories')}}</span>
                            </div>
            ...
            <div class="mx-2 mb-4">
                <a href="{{ route('admin-panel.orders') }}">
                    <x-card class="bg-teal-700 mb-2 hover:shadow-md">
                        <x-card-header class="border-none text-white text-lg font-bold -m-2">
                            <div class="flex items-center">
                ...
                <a href="{{ route('admin-panel.orders') }}">
                    <x-card class="bg-teal-600 mb-2 hover:shadow-md">
                        <x-card-header class="border-none text-white text-md font-bold -m-2">
                            <div class="border-b pb-2">
                                <div class="flex items-center">
                                    <svg width="28" height="28" fill="currentColor" class="bi bi-building-fill-gear" viewBox="0 0 16 16">
                                    ...
                                    <span class="ml-2">{{__('Processing')}}</span>
                                </div>
                            ...
                            <div class="border-b pb-2 pt-0.5">
                                <div class="flex items-center">
                                    <svg width="28" height="28" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
                            ...
                            <div class="pt-1">
                                <div class="flex items-center">
                                    <svg width="28" height="28" fill="currentColor" class="bi bi-cart-check" viewBox="0 0 16 16">
                                        <path d="M11.354 6.354a.5.5 0 0 0-.708-.708L8 8.293 6.854 7.146a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"/>
                                        <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zm3.915 10L3.102 4h10.796l-1.313 7h-8.17zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
                                    </svg>
                                    <span class="ml-2">{{__('Delivered')}}</span>
                                </div>
            ...
            <div class="mx-2 mb-2">
                    ...
                    <x-card class="bg-emerald-600 mb-2 hover:shadow-md">
                        <x-card-header class="border-none text-white text-lg font-bold -m-2">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2">{{__('Branches')}}</span>
                            </div>
                ...
                <x-card class="bg-teal-500 mb-2 hover:shadow-md">
                    <x-card-header class="border-none text-white text-lg font-bold -m-2">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2">{{__('Clients')}}</span>
                        </div>
                        <div class="text-right -mt-7">{{ $clients }}</div>
                    </x-card-header>
                </x-card>

                <x-card class="bg-yellow-700 opacity-80 mb-2 hover:shadow-md">
                    <x-card-header class="border-none text-white text-lg font-bold -m-2">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2">{{__('Purchased Products')}}</span>
                        </div>
        ...
        <div class="grid grid-cols-3">
            <div class="mx-2">
                <x-card>
                    <x-card-header class="text-lg font-bold">
                        {{__('Manage Store')}}
                    </x-card-header>
                    <x-card-body>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni itaque delectus quos, ea praesentium ducimus repellendus, sunt, suscipit unde velit blanditiis! Rerum aliquam hic autem similique id expedita unde quo!
                    </x-card-body>
                </x-card>
            </div>
