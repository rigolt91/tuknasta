        ...
        <div class="mx-2 sm:m-0">
            <div class="grid grid-cols-3">
                        ...
                        <x-card class="mb-2 bg-indigo-600 hover:shadow-md">
                            <x-card-header class="-m-2 font-bold text-white border-none text-md">
                                <div class="pb-2 border-b">
                                    ...
                                    <div class="text-right -mt-7">{{ $processing }}</div>
                                </div>
                                ...
                                <div class="border-b pb-2 pt-0.5">
                                    ...
                                    <div class="text-right -mt-7">{{ $sent }}</div>
                                </div>
                                ...
                                <div class="pt-1">
                                    ...
                                    <div class="text-right -mt-7">{{ $delivered }}</div>
                                </div>
                            </x-card-header>
                        </x-card>
                    </a>
                ...
                <div class="mx-2 mb-2">
                    ...
                    <x-card class="mb-2 bg-indigo-400 hover:shadow-md">
                        <x-card-header class="-m-2 text-lg font-bold text-white border-none">
                            <div class="flex items-center">
