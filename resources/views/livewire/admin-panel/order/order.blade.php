            ...
            <x-card>
                <x-card-body>
                    <div class="pb-2 mb-2 -mt-2 font-bold border-b border-green-300">
                        {{ __('List of Orders') }} ({{ $orders->count() }})

                        <div class="flex float-right -mt-2">
                            <div class="float-right w-48 mr-4">
                            ...
                            <div class="flex">
                                <input wire:model="search" type="search" class="w-full px-2 font-normal border-green-400 rounded rounded-r-none h-9 focus:border-white focus:ring-green-500" autofocus placeholder="{{ __('Search...') }}" />
