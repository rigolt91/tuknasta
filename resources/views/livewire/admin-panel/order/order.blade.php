                ...
                <x-card-body>
                    <div class="pb-2 mb-2 -mt-2 font-bold border-b border-green-300">
                        ...
                        <div class="flex float-right -mt-2 -mr-2 sm:mr-0">
                            ...
                            <svg wire:click="generatePDFOrders" wire:loading.attr='disabled' wire:loading.class='opacity-60' fill="currentColor" class="hidden sm:block p-1 text-green-600 border border-gray-300 rounded-md cursor-pointer bi h-9 bi-printer-fill hover:border-green-600 hover:shadow hover:text-green-800" viewBox="0 0 16 16">
                            ...
                            <tbody>
                                @foreach ($orders as $key => $order)
                                    <x-tr wire:loading.class="opacity-60">
                                        ...
                                        <x-td>
                                            <svg wire:click="generatePDF({{ $order->id }})" wire:loading.attr='disabled' wire:loading.class='opacity-60' fill="currentColor" class="hidden p-1 text-green-600 border rounded-md cursor-pointer sm:block bi h-9 bi-printer-fill hover:border-green-600 hover:shadow hover:text-green-800" viewBox="0 0 16 16">
                                                <path d="M5 1a2 2 0 0 0-2 2v1h10V3a2 2 0 0 0-2-2H5zm6 8H5a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1z"/>
                                                <path d="M0 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-1v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2H2a2 2 0 0 1-2-2V7zm2.5 1a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z"/>
                                            </svg>
                                        </x-td>
