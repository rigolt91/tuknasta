        ...
        <div class="mb-2">
            <div class="flex">
                <div class="w-full mx-2">
                    @livewire('admin-panel.reports.components.orders', ['start_date' => $start_date, 'end_date' => $end_date])
                </div>

                <div class="w-full mx-2">
                    @livewire('admin-panel.reports.components.products', ['start_date' => $start_date, 'end_date' => $end_date])
                </div>

                <div class="w-full mx-2">
                    @livewire('admin-panel.reports.components.profits', ['start_date' => $start_date, 'end_date' => $end_date])
                </div>
            </div>
        </div>
                        ...
                        <x-table>
                            ...
                            <tbody>
                                @foreach ($products as $key => $product)
                                    <x-tr>
                                        <x-td>{{ $carbon->parse($product->date)->isoFormat('dddd') }}</x-td>
