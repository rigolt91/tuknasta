            ...
            <x-card>
                <x-card-body>
                    <div class="pb-2 mb-2 -mt-2 font-bold border-b border-green-300">
                        ...
                        <x-button-inline wire:click="$emit('openModal', 'admin-panel.product.create')" class="flex float-right -mt-2">
                            <x-icon-file-plus />
                            <span class="ml-1">{{ __('New') }}</span>
                        </x-button-inline>

                        <div class="hidden float-right w-48 mr-4 -mt-2 sm:block">
                        ...
                        <div class="hidden float-right w-48 mr-4 -mt-2 sm:">
