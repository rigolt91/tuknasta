    ...
    <div class="flex">
            ...
            <x-slot name="trigger">
                <span class="inline-flex rounded-md">
                    <button type="button"
                        ...
                        <svg class="ml-2 -mr-0.5 h-4 w-4 hidden sm:block" fill="none" viewBox="0 0 24 24"
        ...
        <x-dropdown align="left" width="48">
            <x-slot name="trigger">
                <span class="inline-flex rounded-md">
                    <button type="button"
                        class="inline-flex items-center -mt-2.5 -mb-3 px-2 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 mx-0.5 sm:mx-0 sm:bg-white bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
            ...
            <x-slot name="trigger">
                <span class="inline-flex rounded-md">
                    <button type="button"
                        ...
                        <span class="hidden sm:block">{{ __('Suppliers') }}</span>
        ...
        <x-dropdown align="none" width="48">
            <x-slot name="trigger">
                <span class="inline-flex rounded-md">
                    <button type="button"
                        class="inline-flex items-center bg-gray-100 mx-0.5 sm:mx-0 -mt-2.5 -mb-3 px-2 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 sm:bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                        <svg fill="currentColor" class="h-6 bi bi-file-earmark-text-fill sm:hidden"
                            viewBox="0 0 16 16">
                            <path
            ...
            <x-slot name="trigger">
                <span class="inline-flex rounded-md">
                    <button type="button"
                        ...
                        <svg fill="currentColor" class="h-6 bi bi-file-earmark-bar-graph sm:hidden"
                            viewBox="0 0 16 16">
                            <path
