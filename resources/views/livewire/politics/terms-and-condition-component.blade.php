<div>
    <x-card>
        <x-card-header class="flex items-center">
            <div class="-mt-2 pb-2 text-lg font-bold text-gray-800">{{ __('Terms and Conditions') }}</div>

            <button wire:click="$emit('closeModal')" type="button"
                class="float-right -mt-4 ml-auto -mx-1.5 text-gray-800 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-100 hover:text-green-900 inline-flex h-8 w-8"
                aria-label="Close">
        ...
        <x-card-body>
            <p class="text-gray-700 text-justify text-sm font-bold mb-2">
                {{ __('PLEASE READ THE TERMS AND CONDITIONS OF THIS WEBSITE CAREFULLY. THE USE OF IT CONFIRMS YOUR UNCONDITIONAL ACCEPTANCE OF THE FOLLOWING TERMS AND CONDITIONS. IF YOU DO NOT AGREE TO THE TERMS AND CONDITIONS, DO NOT USE THIS WEBSITE.') }}
            </p>

            <p class="text-gray-700 text-justify text-sm mb-2">
                <span
                    class="border-b border-green-400 font-bold">{{ __('Products, Content and Specifications.') }}</span>
            <div class="text-gray-700 text-justify text-sm mb-2">
                {{ __('All features, content, specifications, products and prices of products and services described or represented on ') }}
                <span class="font-bold uppercase text-green-700">Tukanasta</span>
                {{ __('are subject to change at any time without prior notice. Certain weights, similar measurements, and similar descriptions are approximate and are provided for convenience purposes only.') }}
            </div>
            ...
            <p class="text-gray-700 text-justify text-sm mb-2">
                <span class="font-bold uppercase text-green-700">Tukanasta</span>,
                {{ __('makes all reasonable efforts to correctly display the attributes of our products. The inclusion of products or services on this website at any given time does not imply or guarantee that such products or services will be available at any time. It is your responsibility to determine that all national laws (including minimum age requirements) are complied with in regard to the possession, use and sale of any item purchased on this Website. By placing an order, you represent that the products ordered will be used only in accordance with established laws.') }}
            </p>

            <p class="text-gray-700 text-justify text-sm mb-2">
                <span class="border-b border-green-400 font-bold">{{ __('Delivery Policy.') }}</span>
            ...
            <p class="mb-2 text-gray-700 text-justify text-sm">
                {{ __('The distribution will be made in the national territory for sales made on the') }} <span
                    class="font-bold uppercase text-green-700">Tukanasta</span>
                {{ __('Site under the agreed terms and conditions.') }}
            </p>
            ...
            <p class="mb-2 ml-4 text-gray-700 text-justify text-sm">
            ...
            <p class="text-gray-700 text-justify text-sm mb-2 mt-2">
                <span class="border-b border-green-400 font-bold">{{ __('Information Accuracy.') }}</span>
            ...
            <p class="text-gray-700 text-justify text-sm">
                {{ __('In addition, changes to pricing and availability information are possible without notice. While it is our practice to confirm orders by email, receipt of an order confirmation email does not constitute our acceptance of an order or confirmation of our offer to sell a product or service.') }}
            </p>

            <p class="text-gray-700 text-justify text-sm">
                {{ __('We reserve the right, without notice, to limit the quantity of any product or service and/or to deny service to any customer. Verification of information may also be required prior to acceptance and/or shipment of any order.') }}
            </p>

            <p class="text-gray-700 text-justify text-sm">
                {{ __('If the verification of the information of the purchase or of the customer making the purchase is not correct or it is not possible to verify it, we reserve the right to cancel or limit the quantity of any product or service that we offer.') }}
            </p>
            </p>

            <p class="text-gray-700 text-justify text-sm mb-2 mt-2">
                <span class="border-b border-green-400 font-bold">{{ __('Privacy Policy.') }}</span>
            ...
            <p class="mb-2 text-gray-700 text-justify text-sm">
                <span class="font-bold uppercase text-green-700">Tukanasta</span>
                {{ __('does not assume any responsibility for damages and / or losses due to any virus that could infect your computer, or telecommunications equipment, or other assets arising from the access, use or navigation of this Website, or the information or material on this website.') }}
            </p>
            </p>
            ...
            <p class="text-gray-700 text-justify text-sm mb-2 mt-2">
                <span class="border-b border-green-400 font-bold">{{ __('Termination.') }}</span>
            ...
            <p class="mb-2 text-gray-700 text-justify text-sm">
                {{ __('If you do not understand any of the Terms and Conditions or if you have any questions or comments, we invite you to contact us') }}.
            </p>
            </p>
        </x-card-body>
    </x-card>
