    ...
    <x-card>
        ...
        <x-card-body>
            ...
            <p class="text-gray-700 text-justify text-sm mb-2">
                <span class="border-b border-green-400 font-bold">{{__('Products, Content and Specifications.')}}</span>
                <div class="text-gray-700 text-justify text-sm mb-2">
                    {{__('All features, content, specifications, products and prices of products and services described or represented on ')}} <span class="font-bold uppercase text-green-700">Superbuy.cu</span> {{__('are subject to change at any time without prior notice. Certain weights, similar measurements, and similar descriptions are approximate and are provided for convenience purposes only.')}}
                </div>

            </p>

            <p class="text-gray-700 text-justify text-sm mb-2">
                <span class="font-bold uppercase text-green-700">Superbuy.cu</span>, {{__('makes all reasonable efforts to correctly display the attributes of our products. The inclusion of products or services on this website at any given time does not imply or guarantee that such products or services will be available at any time. It is your responsibility to determine that all national laws (including minimum age requirements) are complied with in regard to the possession, use and sale of any item purchased on this Website. By placing an order, you represent that the products ordered will be used only in accordance with established laws.')}}
            </p>
            ...
            <p class="text-gray-700 text-justify text-sm mb-2 mt-2">
                ...
                <p class="mb-2 text-gray-700 text-justify text-sm">
                    <span class="font-bold uppercase text-green-700">Superbuy.cu</span> {{__('does not assume any responsibility for damages and / or losses due to any virus that could infect your computer, or telecommunications equipment, or other assets arising from the access, use or navigation of this Website, or the information or material on this website.')}}
                </p>
            </p>
