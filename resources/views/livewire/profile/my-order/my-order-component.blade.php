                    ...
                    <div class="pb-2 mb-2 -mt-2 font-bold border-b border-indigo-300">
                        ...
                        <div class="flex float-right -mt-2">
                            <div class="hidden mr-2 sm:flex sm:display">
                                <input wire:model="date" type="date" class="w-full px-2 font-normal text-gray-500 border border-gray-200 rounded h-9 focus:border-indigo-500 focus:ring-indigo-500 focus:border-ring-500" autofocus />
                            </div>
