    ...
    <div class="after:mt-4 after:block after:h-1 after:w-full after:rounded-lg after:bg-gray-200">
        <ol class="grid grid-cols-3 text-sm font-medium text-gray-500">
            <li class="relative text-left text-indigo-600">
                ...
                <span class="hidden sm:block"> {{ __('Personal Information') }} </span>

                <svg class="ml-0 h-6 w-6 sm:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" >
                    <path
            ...
            <li class="relative text-center  text-indigo-600">
                ...
                <span class="hidden sm:block"> {{ __('Delivery') }} </span>

                <svg class="mx-auto h-6 w-6 sm:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
            ...
            <li class="relative text-right mr-2">
                ...
                <span class="hidden sm:block -mr-2"> {{ __('Confirm Payment') }} </span>

                <svg class="ml-auto -mr-2 h-6 w-6 sm:hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
