                    ...
                    <x-card-body>
                        <div class="mt-4 mb-6">
                            <div class="relative">
                                ...
                                <x-input wire:model='email' type="text" class="block w-full mt-1" disabled
                                    :value="old('email', $email)" placeholder="{{ __('Email') }}" autocomplete="email" />
                            </div>
                        ...
                        <div class="items-center pt-1 pb-3 border-b">
                            ...
                            <x-button-inline type="button"
                                wire:click="$emit('openModal', 'profile.my-contact.my-contact-component')"
                                class="items-center float-right w-8 h-8 text-indigo-800 hover:text-white">
            ...
            <div class="mx-4 sm:mx-2 sm:w-3/12">
                <x-button-payment wire:click="paymentDelivery" class="mb-4 cursor-pointer">
                    ...
                    <div class="flex justify-end w-full">
                        <x-icon-spin wire:loading wire:target="paymentDelivery" class="ml-1 float-end" />
                    </div>
                </x-button-payment>
