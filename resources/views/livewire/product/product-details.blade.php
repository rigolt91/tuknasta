    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-6">
            ...
            <div class="w-full mx-4 sm:mx-2 sm:flex">
                <div class="w-full p-6 border border-gray-100 sm:rounded">
                    ...
                    <span class="flex items-center py-3 border-b border-gray-100">
                        <x-icon-star class="w-6 h-6" color="green" />
                        <x-icon-star class="w-6 h-6" color="green" />
                        <x-icon-star class="w-6 h-6" color="green" />
                        <x-icon-star class="w-6 h-6" color="green" />
                        <x-icon-star class="w-6 h-6" color="green" />
                        <span class="pr-4 ml-4 border-r border-gray-300">{{__('5 Starts')}}</span>
                    </span>
                    ...
                    <div class="pt-4 sm:pb-8">
                        ...
                        <x-button wire:click="$emit('addProductCart', [{{ $product_id }}])" wire:loading.attr='disabled' class="flex items-center float-right disabled:opacity-60">
        ...
        <div class="p-2 mt-2 mx-2 sm:mx-0">
            ...
            <div class="flex items-center -my-2">
                @livewire('product.related-products', ['product' => $product_id])
            </div>
        </div>
