        ...
        <x-card-footer class="sm:-mx-6">
            <div class="flex items-center h-8 mt-2 -mx-4 sm:mx-0 sm:-mb-4">
                <div class="font-bold">
                    ...
                    <p class="-mt-2 text-sm text-gray-500">${{ number_format($previous_price, 2) }}</p>
                </div>

                <div class="w-full">
                    <x-button wire:click='addProductCart({{ $product->id }})' wire:loading.attr='disabled' class="float-right duration-150 disabled:opacity-60 hover:scale-110">
