<div>
    @if ($products->count() > 0)
        <div class="grid grid-cols-1 -mx-2 sm:grid-cols-4">
            @foreach ($products as $product)
            <div class="m-2">
                <div class="flex h-full transition ease-in-out border shadow sm:rounded border-gray-50 hover:shadow-xl hover:-translate-y-1 duration-450">
                    ...
                    <div class="w-8/12 mx-2 my-1">
                        <div class="py-1 text-sm font-bold text-gray-800 border-b sm:text-md ">
                            {{ $product->name }}
                            <div>
