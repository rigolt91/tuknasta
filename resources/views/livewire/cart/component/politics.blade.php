<div class="p-4 sm:p-6 my-4 shadow sm:rounded-lg">
    <x-card-body>
        ...
        <a wire:click="$emit('openModal', 'politics.return-policy')" class="flex items-center text-md hover:text-green-800 active:text-green-900 my-2 hover:cursor-pointer">
        ...
        <a wire:click="$emit('openModal', 'politics.customer-support')" class="flex items-center text-md hover:text-green-800 active:text-green-900 hover:cursor-pointer">
