        ...
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose mb-4">
                ...
                <p class="mb-4 text-gray-700 text-justify text-sm">
                    ...
                    <br>
                    {{ __('Tukanasta undertakes not to disclose the data to third parties and to use it only for exchange purposes between us and you. The data can be modified at any time you wish.') }}
                    <br>
                    ...
                    <br>
                    {{ __('Tukanasta assumes no responsibility, and will not be liable, for any damages arising from or related to your failure to maintain the security of your password.') }}
                </p>
            </div>
        </div>
    </div>
