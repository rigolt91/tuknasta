        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-6">
            <div class="mx-4 sm:mx-2">
                <div class="p-2 mt-6 mb-4 bg-white shadow-md sm:p-6 sm:rounded-lg">
                    ...
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        1. {{__('All cancellations must be made through the Customer Service channels by the customer who made the purchase, within a period not exceeding 24 hours after the order was issued.')}}
                    </p>
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        2. {{__('Claims made outside the first 24 hours after the order is delivered will be rejected.')}}
                    </p>
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        3. {{__('For a claim to be valid, you must keep the damaged products and/or original packaging.')}}
                    </p>
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        4. {{__('Items that have been consumed or tampered with may be denied exchange or refund.')}}
                    </p>
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        5. {{__('The exchange of the products may take 5-7 days.')}}
                    </p>
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        6. {{__('Refunds are made exclusively to the payment method used for the purchase. It may take 5-7 days to reflect on the account, depending on the bank of the card used.')}}
                    </p>
                </div>
            </div>
        </div>
