        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-6">
            <div class="mx-4 sm:mx-2">
                <div class="p-2 mt-6 mb-4 bg-white shadow-md sm:p-6 sm:rounded-lg">
                    ...
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        {{__('We have national and foreign suppliers that supply our different purchasing departments across several regions.')}}
                    </p>
                    <p class="mb-4 text-sm text-justify text-gray-700">
                        {{__('Now, with just one click, www.marketplace.example.com offers you an unforgettable experience to satisfy your tastes.') }}
                    </p>
                </div>
            </div>
        </div>
