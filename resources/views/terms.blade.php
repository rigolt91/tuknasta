<x-guest-layout>
    <div class="pt-4 mb-4 bg-gray-100">
        <div class="flex flex-col items-center min-h-screen pt-6 sm:pt-0">
            ...
            <div class="w-full p-6 mt-6 overflow-hidden text-xs prose text-justify text-gray-700 bg-white shadow-md sm:max-w-2xl sm:rounded-lg">
                ...
                <p class="mb-4 text-sm text-justify text-gray-700">
                    1.1.3.- {{__('The recipients to whom the purchase is directed must be over 18 years of age and be mentally fit to carry out this act.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                ...
                <p class="mb-4 text-sm text-justify text-gray-700">
                    1.2.1 {{__('The prices of the products and services that are marketed on the site, as well as the delivery costs are expressed in US dollars.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    1.2.2 {{__('Delivery costs are added to the purchase price in accordance with the specifications given for each included product or service.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    1.3.- {{__('PAYMENTS:')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    1.3.1.- {{__('Payments will be made through the following credit or debit cards:')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    a) {{__('Visa,')}}
                </p>
                ...
                <p class="mb-4 text-sm text-justify text-gray-700">
                    a) {{__('from 51 to 60 kilograms $3 US dollars;')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    b) {{__('from 51 to 70 kilograms $5 US dollars;')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    c) {{__('from 71 to 80 kilograms $10 US dollars,')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    d) {{__('from 81 to 90 kilograms $15 US dollars,')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    e) {{__('from 91 to 100 kilograms $20 US dollars, and')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    f) {{__('from 101 kilograms onwards $30 US dollars.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                ...
                <p class="mb-4 text-sm text-justify text-gray-700">
                    1.4.7.- {{__('The recipient will sign the delivery voucher with the products received.')}}
                </p><p class="mb-4 text-sm text-justify text-gray-700">
                    1.4.8.- {{__('Orders can be received at various times, taking into account if they include products that require special transportation or if they correspond to different suppliers.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                ...
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.1.- {{__('For electrical appliances and electronic products, the warranty period will depend on the type of equipment and will be specified in the product description in the certificate of ownership and warranty that the recipient will receive with the delivery of the product, in addition the following will be specified in these documents items:')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    a) {{__('Warranty terms and conditions, and')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    b) {{__('contact numbers, and the address of the workshops to which you can go and make use of it.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.2.- {{__('In order for the recipient to be entitled to receive the warranty service, he must do the following:')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    a) {{__('Allow specialists to diagnose the team;')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    b) {{__('Maintain the integrity of the equipment guarantee seal;')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    c) {{__('Keep and show the following documents when requesting warranty service:')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                ...
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.5.- {{__('This same procedure will be taken into account when products that are not physically found are reflected in the delivery voucher.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.6.- {{__('In the cases in which there is a claim, the store will offer you a credit so that at any other time you can buy any other product for the amount not consumed in the initial order.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.7.- {{__('Once the products have been received and the delivery voucher signed by the recipient, no claims for shortages, breakages or deterioration of the same will be accepted.')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.8 {{__('Returns')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    2.8.1- {{__('Returns will be made for different reasons attributable to the buyer or recipient of the service, such as:')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    a) {{__('Product or Order not delivered')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    b) {{__('Product that does not correspond to its description')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    c) {{__('Product in poor condition')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
                    d) {{__('Delayed delivery of the Product or Order')}}
                </p>
                <p class="mb-4 text-sm text-justify text-gray-700">
