<x-guest-layout>
    <div class="pt-4 bg-gray-100 mb-4">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                <p class="mb-4 pb-2 text-lg font-bold text-gray-800">{{ __('Terms and Conditions') }}</p>
                ...
                <p class="text-gray-700 text-justify text-sm mt-2">
