...
<a href="{{ $route }}" class="inline-flex items-center w-full px-2 py-2 mt-4 text-xs font-semibold tracking-widest text-gray-800 uppercase transition duration-150 ease-in-out bg-indigo-100 border border-green sm:rounded hover:bg-indigo-500 hover:scale-105 hover:shadow-md focus:bg-indigo-500 active:bg-indigo-600 active:shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
