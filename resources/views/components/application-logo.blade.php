...
<svg viewBox="0 0 200 56" xmlns="http://www.w3.org/2000/svg" width="{{ $width }}" height="{{ $height }}"
    ...
    <rect x="0" y="4" width="48" height="48" rx="12" fill="#0f766e" />
    ...
    <text x="58" y="36" font-family="'Nunito', 'Segoe UI', sans-serif" font-size="24" font-weight="800" fill="#0f172a">Market<tspan fill="#0f766e">Plaza</tspan></text>
</svg>
